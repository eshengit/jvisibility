...
class MyTestCase(unittest.TestCase):
    ...
    def test_timezone_conversion(self):
        self.assertEqual(backend.functions.get_time_in_utc_timezone("2023-01-03-17-27", "US/Pacific").strftime('%m-%d-%H-%M'),
                         '01-04-01-27')

    def test_get_next_n_records(self):
        # get_next_n_records(root_dir, start_datetime, list_of_record, number_of_records=1):
        start_time = backend.functions.get_time_in_utc_timezone("2023-01-03-17-27", "US/Pacific")
        root_dir = "/var/tmp/"
        ...
        time_does_not_exist = backend.functions.get_time_in_utc_timezone("2023-01-03-18-27", "US/Pacific")
